...
def render() -> Path:
    ...
    add("- **tier-a references are the script, not a verbatim record.** In 4 of "
        "the 15 clips (case09, case12, case13, case21) the speaker added "
        "discourse openers and tails that are not in the reference, e.g. "
        "*\"How far na,\"* before *\"wetin I sell pass this week\"*, and "
        "*\"My guy, … o, I don sell am finish\"* around *\"I don sell garri "
        "finish\"*. Every model hears the extra words, so tier-a WER is inflated "
        "for all of them. Found on 13 September while preparing the audio for "
        "release, after all scoring. Sensitivity check, excluding those four "
        "clips: Sahara v2.5 0.574 → 0.358 and still first; Parakeet 0.651 → "
